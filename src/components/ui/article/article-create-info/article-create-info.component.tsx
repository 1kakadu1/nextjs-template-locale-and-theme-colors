...
export const ArticleCreateInfo = ({ className="", preview, name, date , classNameUser}:IArticleCreateInfoProps) => {
  return (
				<div className={cl.card+" "+className}>
					<UserPreview avatar={preview} name={name} className={classNameUser}/>
